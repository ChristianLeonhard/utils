...
public class QrcodeUtils {
     ...
     * @return 二维码图片文件
     */
    public static File createQrcodeToFile(String content, int length, File logoFile) {
        if (logoFile != null && !logoFile.exists()) {
            throw new IllegalArgumentException("请提供正确的logo文件！");
        }
     ...
     * @return 二维码图片的字节数组
     */
    public static File createQrcodeToFile(String content, File logoFile) {
        return createQrcodeToFile(content, DEFAULT_LENGTH, logoFile);
    }
     ...
     * @return 二维码图片文件
     */
    public static String createQrcodeToFileAbsolutePath(String content, int length, File logoFile) {
        if (logoFile != null && !logoFile.exists()) {
            throw new IllegalArgumentException("请提供正确的logo文件！");
        }
        ...
        try {
            ...
            String absolutepath = file.getAbsolutePath();//获取当前文件的绝对路径+相对路径
            return absolutepath;
        } catch (Exception e) {
            logger.warn("内容为：【" + content + "】的二维码生成失败！", e);
            return null;
     ...
     * @return 二维码图片的字节数组
     */
    public static String createQrcodeToFileAbsolutePath(String content, File logoFile) {
        return createQrcodeToFileAbsolutePath(content, DEFAULT_LENGTH, logoFile);
    }
     ...
     * @return 二维码图片文件
     */
    public static String createQrcodeToFileCanonicalPath(String content, int length, File logoFile) {
        if (logoFile != null && !logoFile.exists()) {
            throw new IllegalArgumentException("请提供正确的logo文件！");
        }
        ...
        try {
            ...
            String canonicalpath = file.getCanonicalPath();//获取当前文件的绝对路径
     ...
     * @return 二维码图片的字节数组
     */
    public static String createQrcodeToFileCanonicalPath(String content, File logoFile) {
        return createQrcodeToFileCanonicalPath(content, DEFAULT_LENGTH, logoFile);
    }
     ...
     * @return 二维码图片文件
     */
    public static String createQrcodeToFilePath(String content, int length, File logoFile) {
        if (logoFile != null && !logoFile.exists()) {
            throw new IllegalArgumentException("请提供正确的logo文件！");
        }
        ...
        try {
            ...
            String path = file.getPath();//获取当前文件的相对路径
            return path;
        } catch (Exception e) {
            logger.warn("内容为：【" + content + "】的二维码生成失败！", e);
            return null;
     ...
     * @return 二维码图片的字节数组
     */
    public static String createQrcodeToFilePath(String content, File logoFile) {
        return createQrcodeToFilePath(content, DEFAULT_LENGTH, logoFile);
    }
